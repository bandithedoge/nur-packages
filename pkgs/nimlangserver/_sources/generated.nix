# This file was generated by nvfetcher, please do not modify it manually.
{
  ...
  chronicles = {
    pname = "chronicles";
    version = "a537556963bb42e048c7f7229456995355d360e5";
    src = fetchgit {
      url = "https://github.com/status-im/nim-chronicles";
      rev = "a537556963bb42e048c7f7229456995355d360e5";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [];
      sha256 = "sha256-GQ7Lc/Yk0o1Y+znF+Ei2sMGXYDRwhcWyfoDio3ISTqI=";
    };
    date = "2025-05-26";
  };
  chronos = {
  ...
  faststreams = {
    pname = "faststreams";
    version = "c51315d0ae5eb2594d0bf41181d0e1aca1b3c01d";
    src = fetchgit {
      url = "https://github.com/status-im/nim-faststreams";
      rev = "c51315d0ae5eb2594d0bf41181d0e1aca1b3c01d";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [];
      sha256 = "sha256-bVsVH6NiAL1af9rGFTTyJL3h0t0pYR+pEULOxdD1FHU=";
    };
    date = "2025-04-25";
  };
  httputils = {
  ...
  nimcrypto = {
    pname = "nimcrypto";
    version = "19c41d6be4c00b4a2c8000583bd30cf8ceb5f4b1";
    src = fetchgit {
      url = "https://github.com/cheatfate/nimcrypto";
      rev = "19c41d6be4c00b4a2c8000583bd30cf8ceb5f4b1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [];
      sha256 = "sha256-CloiQdCdr+PsC89BVtmhWRk1HeX7/kE2Y0p6hage4v8=";
    };
    date = "2025-05-07";
  };
  nimlangserver = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.12.0";
      fetchSubmodules = false;
      sha256 = "sha256-yf3oiKwsJoQxRPhbEBMJN+TR7j58t6ggjq51DJ3ypGQ=";
    };
  };
  regex = {
    pname = "regex";
