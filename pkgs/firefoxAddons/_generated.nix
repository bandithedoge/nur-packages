...
}:
{
  "augmented-steam" = buildFirefoxXpiAddon {
    ...
    url = "https://addons.mozilla.org/firefox/downloads/file/4656515/augmented_steam-4.6.0.xpi";
    sha256 = "959bca70270267ffa4f7ce54df555fb81702e7e9dafd3f74d211403e1888d1e5";
    meta = with lib; {
